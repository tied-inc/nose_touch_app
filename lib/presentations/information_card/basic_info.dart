                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => TextForm(
                            ...
                            onSave: (value) {
                              final petInfo =
                                  data.copyWith(microchipNumber: value);
                              notifier.upsertBasicInfo(petInfo);
                            },
                          )));
                },
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => TextForm(
                            ...
                            onSave: (value) {
                              final petInfo =
                                  data.copyWith(characteristics: value);
                              notifier.upsertBasicInfo(petInfo);
                            },
                          )));
                },
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => TextForm(
                            ...
                            onSave: (value) {
                              final petInfo =
                                  data.copyWith(hospitalName: value);
                              notifier.upsertBasicInfo(petInfo);
                            },
                          )));
                },
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => TextForm(
                            ...
                            onSave: (value) {
                              final petInfo =
                                  data.copyWith(medicalHistory: value);
                              notifier.upsertBasicInfo(petInfo);
                            },
                          )));
                },
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => TextForm(
                            ...
                            onSave: (value) {
                              final petInfo =
                                  data.copyWith(medicalCondition: value);
                              notifier.upsertBasicInfo(petInfo);
                            },
                          )));
                },
